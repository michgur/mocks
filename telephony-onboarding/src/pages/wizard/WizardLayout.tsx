...
export function WizardLayout({ steps, current, onBack, onCancel, onNext, nextLabel = 'Next', nextDisabled, onInsertMockData, children }: Props) {
      ...
      <footer className="border-t bg-background">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between gap-3 px-6">
          <div className="flex items-center gap-2">
            ...
            {onInsertMockData && (
              <Button variant="ghost" size="sm" onClick={onInsertMockData} className="text-muted-foreground">
                Insert mock data
              </Button>
            )}
          </div>
